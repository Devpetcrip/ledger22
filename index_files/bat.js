function UET(o) {
    ...
    this.loadConfig = function() {
        ...
        s = "_uetmsdns";
        o.hasOwnProperty("msDnsCookie") && o.msDnsCookie && typeof o.msDnsCookie == "string" && (s = o.msDnsCookie);
        ...
        for (u in o) h.hasOwnProperty(u) && (this.beaconParams[u] = h[u] === 1 ? encodeURIComponent(o[u]) : o[u]);
        for (this.beaconParams.mid = this.getUuidV4(!0), t = undefined, c = 0; c < 5; c++)
            if (t = "ueto_" + this.makeRandomStr(10), !window[t]) break;
        this.stringExists(o.ti) && (y = ["56004448", "5798164", "20132024", "4000835", "4074038"], l = window.navigator.userLanguage || window.navigator.language, this.stringExists(l) && l.indexOf("de") === 0 && y.indexOf(o.ti) !== -1 && (this.uetConfig.deBlock = !0, this.uetConfig.cookieAllowed = !1));
        try {
            this.stringExists(t) && !window[t] ? window[t] = this.uetInstance : t = undefined
        } catch (n) {}
        this.stringExists(o.ti) && (n = document.createElement("script"), a = f + "//" + this.domain + "/p/action/" + o.ti + ".js", this.stringExists(this.uetConfig.batDebug) && (a += "?bat_debug=" + this.uetConfig.batDebug), n.src = a, n.type = "text/javascript", n.async = 1, t && n.setAttribute("data-ueto", t), document.head.appendChild(n));
        navigator.userAgentData && navigator.userAgentData.getHighEntropyValues && navigator.userAgentData.platform === "Windows" && (this.deferLoad = !0, i = this, v = setTimeout(function() {
            i.deferLoad = !1;
