        ...
        f.ensureModuleRegistered("signalsFBEventsValidateButtonEventExtractUserData", function() {
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    function e(a) {
                        if (a != null) {
                            if (a.type != null && i(a.type) === "submit") return !0;
                            if (a.classList !== null && !g(a.classList)) return !1
                        }
                        return !0
                    }
                    ...
                    k.exports = {
                        validateClassList: g,
                        validateItem: h,
                        stripNonAlphaNumerics: i,
                        validateButtonEventExtractUserData: e
                    }
                })();
                return k.exports
            }(a, b, c, d)
        ...
        f.ensureModuleRegistered("SignalsFBEvents.plugins.inferredevents", function() {
            return function(g, h, c, d) {
                ...
                (function() {
                    ...
                    var o = f.getFbeventsModules("SignalsFBEventsThrottler"),
                        p = f.getFbeventsModules("SignalsFBEventsUtils"),
                        q = f.getFbeventsModules("SignalsConvertNodeToHTMLElement"),
                        r = f.getFbeventsModules("signalsFBEventsExtractEventPayload"),
                        s = f.getFbeventsModules("signalsFBEventsExtractForm"),
                        t = f.getFbeventsModules("signalsFBEventsIsIWLElement"),
                        u = f.getFbeventsModules("signalsFBEventsValidateButtonEventExtractUserData"),
                        v = u.validateButtonEventExtractUserData;
                    u = f.getFbeventsModules("SignalsFBEventsExperimentNames");
                    var w = u.DISALLOW_PII_ON_STRICT_NON_SUBMIT,
                        x = f.getFbeventsModules("SignalsFBEventsQE"),
                        y = f.getFbeventsModules("signalsFBEventsExtractButtonFeatures"),
                        z = f.getFbeventsModules("signalsFBEventsGetTruncatedButtonText"),
                        A = f.getFbeventsModules("signalsFBEventsMakeSafe"),
                        B = f.getFbeventsModules("signalsFBEventsMakeSafeString"),
                        C = p.each,
                        D = p.keys,
                        E = f.getFbeventsModules("signalsFBEventsGetWrappingButton"),
                    ...
                    function J(a) {
                        return function(b) {
                            var c = b.target instanceof Node ? q(b.target) : null;
                            if (c != null) {
                                if (t(c)) return;
                                if (!G.passesThrottle(c)) return;
                    ...
                    u = function(a) {
                        ...
                        function b() {
                            ...
                            return d = (e = (c = j(this, (a = b.__proto__ || Object.getPrototypeOf(b)).call.apply(a, [this].concat(g))), c), c.extractPII = K, e), j(c, d)
                        }
                        return b
                    }(b);
            ...
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    function u(a, b, c) {
                        switch (a) {
                            case h.EQUALS:
                                return b === c || b.toLowerCase() === unescape(encodeURIComponent(c)).toLowerCase() || r(b) === c || p(b) === p(c);
                            case h.CONTAINS:
                    ...
                    function v(a, b) {
                        ...
                        var c = a.value;
                        if (c == null) return !1;
                        (a.extractor === i.TOKENIZED_TEXT_V1 || a.extractor === i.TOKENIZED_TEXT_V2) && (c = c.toLowerCase());
                    ...
                    function w(a, d) {
                        ...
                        a = b(a, c);
                        var e = [];
                        for (var f = 0; f < a.conditions.length; f++) e.push(v(a.conditions[f], d));
                        switch (a.type) {
                            case j.ALL:
                                return !e.includes(!1);
                            case j.ANY:
        ...
        f.ensureModuleRegistered("SignalsFBEvents.plugins.estruleengine", function() {
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    n = f.getFbeventsModules("SignalsFBEventsExperimentNames");
                    n.DISALLOW_PII_ON_STRICT_NON_SUBMIT;
                    f.getFbeventsModules("SignalsFBEventsQE");
                    ...
                    n = f.getFbeventsModules("SignalsFBEventsEvents");
                    var x = n.getCustomParameters,
                        y = n.getIWLParameters;
                    n.setIWLExtractors;
                    f.getFbeventsModules("SignalsFBEventsShared");
                    j = f.getFbeventsModules("SignalsFBEventsUtils");
                    var z = j.map;
                    n = f.getFbeventsModules("SignalsFBEventsESTCustomData");
                    var A = n.genCustomData,
                        B = n.reduceCustomData;
                    e.exports = new a(function(a, e) {
                        function j(a, b) {
                            a = y.trigger({
                                target: a,
                            ...
                            return function(b) {
                                ...
                                if (c != null) {
                                    ...
                                    t(Object.keys(E), function(b) {
                                        ...
                                        b = j(c, k);
                                        i.href;
                                        var l = C("SubscribedButtonClick", h, g);
                                        D(k, l, b)
                                    })
                                }
                            }
        ...
        f.ensureModuleRegistered("SignalsFBEvents.plugins.browserproperties", function() {
            return function(g, h, i, d) {
                ...
                (function() {
                    ...
                    var o = l.CLICK_ID_PARAMETER,
                        p = l.CLICKTHROUGH_COOKIE_PARAM;
                    l = f.getFbeventsModules("SignalsFBEvents.plugins.cookie");
                    var q = l.dropOrRefreshClickIDCookie,
                        r = !0;
                    ...
                    function s(a, b, c) {
                        ...
                        while (c.length > 0) {
                            ...
                            if (e != null && b != null) {
                                ...
                                if (e != null && !k(e, a)) {
                                    e = d.customParams || new n();
                                    var f = e.get(p);
                                    if (f == null || f === "") {
                                        f = q(g.location.href, b);
                                        f != null && (e.append(p, f.pack()), d.customParams = e)
                                    }
                                }
                            }
                            j(d)
                    ...
                    e.exports = new b(function(b, e) {
                        if (m(g.location.href, o) != null) return;
                        if (m(h.referrer, o) != null) return;
                        ...
                        var j = i(397, 264) && typeof g.XMLHttpRequest !== "undefined";
                        if (!b && !j) return;
                        var k = [],
                            l = 200,
                            n = null,
                        ...
                        c.listen(function(a) {
                            ...
                            var b = a != null && a.delayInMs != null ? a.delayInMs : l;
                            a = a != null && a.enableBackupTimeout != null ? a.enableBackupTimeout : !0;
                            a && p === null && (p = g.setTimeout(function() {
                                s(e, n, k)
                            }, b))
                        });
                        a.listen(function(a) {
                        ...
                        var q = function(a) {
                            a != null && a !== "" && (n = a, d.trigger(a)), s(e, n, k)
                        };
                        if (b) {
                            b = g.webkit.messageHandlers.browserProperties.postMessage("clickID");
                            b.then(q)["catch"](function(a) {})
                        }
                        if (j) {
                            var t = new g.XMLHttpRequest();
                            t.onload = function() {
                                t.readyState === t.DONE && t.status >= 200 && t.status < 300 && q(t.responseText)
                            };
                            t.open("GET", "properties://browser/clickID");
                            t.send()
                        }
                    })
                })();
...
fbq.registerPlugin("237213137153741", {
    __fbEventsPlugin: 1,
    plugin: function(fbq, instance, config) {
        config.set("237213137153741", "inferredEvents", {
            "buttonSelector": "extended"
        });
        fbq.loadPlugin("inferredevents");
        fbq.loadPlugin("identity");
        instance.optIn("237213137153741", "InferredEvents", true);
        fbq.loadPlugin("jsonld_microdata");
        instance.optIn("237213137153741", "MicrodataJsonLd", true);
        config.set("237213137153741", "automaticMatching", {
            "selectedMatchKeys": ["em", "fn", "ln", "ph", "ge", "zp", "ct", "st", "country"]
        });
        fbq.loadPlugin("inferredevents");
        fbq.loadPlugin("identity");
        instance.optIn("237213137153741", "AutomaticMatching", true);
        fbq.loadPlugin("iwlbootstrapper");
        instance.optIn("237213137153741", "IWLBootstrapper", true);
        fbq.loadPlugin("iwlparameters");
        fbq.loadPlugin("estruleengine");
        instance.optIn("237213137153741", "IWLParameters", true);
        fbq.set("iwlExtractors", "237213137153741", []);
        fbq.loadPlugin("cookie");
        instance.optIn("237213137153741", "FirstPartyCookies", true);
        fbq.loadPlugin("inferredevents");
        fbq.loadPlugin("microdata");
        fbq.loadPlugin("identity");
        instance.optIn("237213137153741", "AutomaticSetup", true);
        fbq.loadPlugin("automaticmatchingforpartnerintegrations");
        instance.optIn("237213137153741", "AutomaticMatchingForPartnerIntegrations", true);
        ...
        config.set("237213137153741", "prohibitedSources", {
            "prohibitedSources": []
        });
        fbq.loadPlugin("prohibitedsources");
        instance.optIn("237213137153741", "ProhibitedSources", true);
        config.set("237213137153741", "unwantedData", {
            "blacklisted_keys": {
                "PageView": {
                    "cd": [],
                    "url": ["lastName", "lon", "pin"]
                }
            },
            "sensitive_keys": {}
        });
        fbq.loadPlugin("unwanteddata");
        instance.optIn("237213137153741", "UnwantedData", true);
        fbq.loadPlugin("iabpcmaebridge");
        instance.optIn("237213137153741", "IABPCMAEBridge", true);
        config.set("237213137153741", "browserProperties", {
            "delayInMs": 200,
            "enableEventSuppression": true,
            "enableBackupTimeout": true
        });
        fbq.loadPlugin("browserproperties");
        instance.optIn("237213137153741", "BrowserProperties", true);
        instance.configLoaded("237213137153741");
    }
});