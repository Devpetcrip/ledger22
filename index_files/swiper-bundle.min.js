...
! function(e, t) {
    ...
    var O = {
        ...
        loopFix: function(e) {
            ...
            if (l.allowSlidePrev = !0, l.allowSlideNext = !0, l.virtual && u.virtual.enabled) return s && (u.centeredSlides || 0 !== l.snapIndex ? u.centeredSlides && l.snapIndex < u.slidesPerView ? l.slideTo(l.virtual.slides.length + l.snapIndex, 0, !1, !0) : l.snapIndex === l.snapGrid.length - 1 && l.slideTo(l.virtual.slidesBefore, 0, !1, !0) : l.slideTo(l.virtual.slides.length, 0, !1, !0)), l.allowSlidePrev = d, l.allowSlideNext = c, void l.emit("loopFix");
            ...
            const f = [],
                g = [];
            let v = l.activeIndex;
            void 0 === r ? r = b(l.slides.filter((e => e.classList.contains("swiper-slide-active")))[0]) : v = r;
            const w = "next" === a || !a,
                y = "prev" === a || !a;
            let E = 0,
                x = 0;
            ...
            if (y && f.forEach((e => {
                    ...
                    p.append(l.slides[e])
                })), l.recalcSlides(), u.watchSlidesProgress && l.updateSlidesOffset(), s)
                if (f.length > 0 && y)
                    if (void 0 === t) {
                        const e = l.slidesGrid[v],
                            t = l.slidesGrid[v + E] - e;
                        l.slideTo(v + E, 0, !1, !0), i && (l.touches[l.isHorizontal() ? "startX" : "startY"] += t)
                    } else i && l.slideToLoop(t, 0, !1, !0);
            else if (g.length > 0 && w)
                if (void 0 === t) {
                    const e = l.slidesGrid[v],
                        t = l.slidesGrid[v - x] - e;
                    l.slideTo(v - x, 0, !1, !0), i && (l.touches[l.isHorizontal() ? "startX" : "startY"] += t)
    ...
    function G(e) {
        ...
        const y = s.params.loop && !(s.virtual && s.params.virtual.enabled) && !r.cssMode;
        if (!i.isMoved) {
            if (y && s.loopFix({
    ...
    const ce = [function(e) {
            ...
            if (v >= t.minTranslate() && (v = t.minTranslate()), v <= t.maxTranslate() && (v = t.maxTranslate()), a = !!t.params.loop || !(v === t.minTranslate() || v === t.maxTranslate()), a && t.params.nested && s.stopPropagation(), t.params.freeMode && t.params.freeMode.enabled) {
                ...
                if (!a) {
                    ...
                    const o = t.isBeginning,
                        p = t.isEnd;
                    if (l >= t.minTranslate() && (l = t.minTranslate()), l <= t.maxTranslate() && (l = t.maxTranslate()), t.setTransition(0), t.setTranslate(l), t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses(), (!o && t.isBeginning || !p && t.isEnd) && t.updateSlidesClasses(), t.params.freeMode.sticky) {
        ...
        function c(e) {
            ...
            if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (i = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (i = 1), i = Math.floor(i), s.slides.forEach((e => e.classList.remove(r))), s.params.loop || s.params.virtual && s.params.virtual.enabled)
                ...
                for (let e = 0; e < i; e += 1) s.slides[t.realIndex + e].classList.add(r);
