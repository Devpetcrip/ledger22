! function() {
    ...
    function m(e, t, n, i) {
        ...
        this.tcfv1ConsentProvider = new a(e, o, A.info), this.tcfv2ConsentProvider = new c(e, o, A.info), this.ccpaConsentProvider = new l(e, r, A.info)
    }
    ...
    var q = (T.prototype.fillQueryStringParams = function(e, t) {
    ...
    var H = (_.prototype.createIframe = function(e, t, n, i, o) {
        var r = document.createElement("iframe"),
            a = encodeURIComponent || escape,
            s = N.getHighestAccessibleUrl(window),
            c = a(N.extractHostname(s)),
        ...
        return "#gum-debug-mode" === window.location.hash ? d += "?debug=1&topUrl=" + c : d += "?topUrl=" + c, u && (d += "&origin=" + u), n && (E(n) ? (void 0 !== n.gdprApplies && (d += "&gdpr=" + (n.gdprApplies ? 1 : 0)), void 0 !== n.consentData && (d += "&gdpr_consent=" + n.consentData)) : F(n) && void 0 !== n.uspString && (d += "&us_privacy=" + n.uspString)), d += "#" + JSON.stringify(l), r.src = d, r.id = this.gumSyncFrameId, r.width = "0", r.height = "0", r.frameBorder = "0", r.setAttribute("style", "border-width:0px; margin:0px; display:none"), r.title = "Criteo GUM iframe", N.removeLater(i, r), r
    ...
    var D, X = (Z.prototype.isChrome = function() {
    ...
    if (!window.criteo_q || window.criteo_q instanceof Array) {
        ...
        window.criteo_q = function() {
            ...
            function i(t, n, i, o, r, a, s, c, e) {
                if (t.shouldInjectSyncframe()) {
                    var u = t.createIframe(o, a.tagVersion, e, P, a.privateModeDetectionEnabled);
                ...
                if (r.onFlush instanceof Function && (r.onFlush(), A.warn("on flush hook is deprecated and will soon be removed. Please do not use it and contact criteo if you think this may break your integration")), 0 !== n.actions.length) {
                    ...
                    var C = !1,
                        k = function(e, t, n, i, o) {
                            ...
                            null !== o.account && a.push("a=" + D(i, o.account, []));
                            "js" !== o.responseType && a.push("rt=" + D(i, o.responseType, []));
                            if (o.handlerParams) {
                                var s = decodeURIComponent(D(i, o.handlerParams, []));
                                s && a.push(s)
                            }
                            var c = function() {
                            ...
                            if (void 0 !== c) {
                                ...
                                a.push("csp-nonce=" + u(c))
                            }
                            t.tryAppendUatParameter(a);
                            for (var l = 0; l < r.length; ++l) {
                                var d = r[l];
                                d.account && W(null === o.account ? void 0 : o.account, null === d.account ? void 0 : d.account) && delete d.account, a.push("p" + l + "=" + D(i, d, []))
                            }
                            n.fillQueryStringParams(a, o), null !== o.partnerPayload && a.push("pp=" + D(i, o.partnerPayload, []));
                    ...
                    var b = function() {
                        if (!C) {
                            ...
                            "function" == typeof r.onUrlGenerated ? r.onUrlGenerated(t.url) : "beacon" === o.requestType && navigator.sendBeacon ? navigator.sendBeacon(t.url) : S(n, a, r, t), A.info("DIS call triggered", t.url, k), n.eventSent = !0, T.registerTrigger(e), a.disOnce || (n.disingScheduled = [])
                        }
                    };
                    _(function(e) {
            ...
            function D(e, t, n) {
                var i, o, r, a = "";
                if (t instanceof Function) a = D(e, t(), n);
                else if (t instanceof Array) {
                    for (var s = [], c = 0; c < t.length; ++c) s[c] = D(e, t[c], n);
                    a += "[" + s.join(",") + "]"
                    ...
                    for (var l in t)
                        if (t.hasOwnProperty(l)) {
                            var d = n.concat([l]);
                            u.push((i = e, o = l, void 0, r = d.join("."), (i.properties[r] ? i.properties[r] : o) + "=" + D(e, t[l], d)))
                        }
                    a += u.join("&")
            ...
            return P.catchAndStoreException(function() {
                return w.checkAcid(), w.checkClientSideIdentityStatus(), w.setCop(window),
                    function(e, t, n, i, o, r, a, s) {
                        ...
                        y.hooks.onInitialized instanceof Function ? (v.app.bodyReady = y.hooks.onInitialized(), A.warn("onInitialized hook is deprecated and will soon be removed. Please do not use it and contact criteo if you think this may break your integration")) : v.app.bodyReady = !0, _(function(e) {
        ...
        }(), $.adBlockDetector, window.criteo_q.adBlockDetector = $.adBlockDetector, (D = window.criteo_q).push.apply(D, $)
    }
}();